package org.java.org.modernjava.testdata.transactions;
...
public class TestDataGenerator {
    ...
    public static List<Transaction> getTestTransactionsData() {
        // Test data
        ...
        final Customer marleen = new Customer("Marleen", "Auckland");
        ...
        return Arrays.asList(
                ...
                new Transaction(marleen, 100, 90, checkout_2, 2019, Currency.USD),
