package org.java.org.modernjava.stream.patitioning;

import static java.util.stream.Collector.Characteristics.IDENTITY_FINISH;
import static org.java.org.modernjava.stream.patitioning.PartitioningMethods.isComposite;
...
public class CompositeNumbersCollector implements Collector<Integer, Map<Boolean, List<Integer>>, Map<Boolean, List<Integer>>> {
    ...
    public BiConsumer<Map<Boolean, List<Integer>>, Integer> accumulator() {
        return (Map<Boolean, List<Integer>> container, Integer candidate) -> {
            ...
            container.get(isComposite(candidate)).add(candidate);
        };
    }
