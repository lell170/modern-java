...
import org.java.modernjava.testdata.transactions.Currency;
...
public class CollectorMethods {
    ...
    // grouping by example
    static Map<org.java.modernjava.testdata.transactions.Currency, Optional<Transaction>> getMapHighestValueByCurrencyOptional(List<Transaction> transactionList) {
        return transactionList
                .stream()
    ...
    static Map<org.java.modernjava.testdata.transactions.Currency, Transaction> getMapHighestValueByCurrency(List<Transaction> transactionList) {
        return transactionList
                .stream()
